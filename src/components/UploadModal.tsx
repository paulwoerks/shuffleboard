            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div
                        ...
                        onDrop={handleDrop}
                        className={`relative group cursor-pointer border-2 border-dashed rounded-3xl transition-all flex flex-col items-center justify-center overflow-hidden h-130
